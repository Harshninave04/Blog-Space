...
export default function Index() {
  return (
    <section>
      ...
      >
        <article className=' mix-blend-difference'>
          <h1 className='lg:text-4xl md:text-3xl text-xl text-center font-semibold text-white'>
            ✨ Experience Interactive Reading with<br />
            Dynamic Content
          </h1>
        </article>
      </ImageMouseTrail>
